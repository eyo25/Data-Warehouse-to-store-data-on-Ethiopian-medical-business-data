...
SAVE_DIR = 'C:/Users/eyosi/OneDrive/Desktop/10Acadamy/Week7/Images/chemed'
...
with client:
    ...
    client.loop.run_until_complete(download_images(channel_name,start_date=datetime(2024, 6 , 1, tzinfo=timezone.utc), end_date=datetime(2024, 6, 12, tzinfo=timezone.utc),max_images=100))
